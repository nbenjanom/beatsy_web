...
class CommunityProfile extends React.Component {
  ...
  componentDidMount(){
    ...
    .then(tracks => {
      ...
      console.log("#CommunityProfile - tracks.data[0].user.username: ", tracks.data[0].user.username)
      this.setState({
          tracks : tracks.data,
          userName : tracks.data[0].user.username
        });
    });
          ...
          {/* <div style={{width: "100%",height:320,position: "relative", top:-50 }}>
           ...
           <div className="row pb-4">  
            <div className="col-12 text-center">    
              ...
              <Names className="pt-5">{this.state.userName}</Names>
            </div> 
          </div>  
